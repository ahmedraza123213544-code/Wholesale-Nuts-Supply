...
const normalizeReceiptAddress = (address?: string): string => {
  ...
  if (!normalized) {
    return "Bahadurabad, Karachi, Pakistan";
  }
...
const buildReceiptBranchLine = (
  ...
  if (!name || ["ADMIN", "WHOLESALE NUT SUPPLY"].includes(name.toUpperCase())) {
    return "Bahadurabad, Karachi, Pakistan";
  }
    ...
    const loadBranchInfo = async () => {
      try {
        ...
        setBranchInfo({
          ...
          address: branchRes.data.data.address || "Bahadurabad, Karachi, Pakistan",
        });
      } catch (error) {
