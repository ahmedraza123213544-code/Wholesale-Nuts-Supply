    ...
    <section ref={root} className="relative overflow-hidden py-20 md:py-28">
      <div className="absolute inset-0">
        <Image
          ...
          alt="Wholesale nuts ready for business partnership"
          fill
          sizes="100vw"
          className="why-cta-bg object-cover scale-105"
        />
      ...
      <div className="container-page relative">
        <div className="why-cta-content mx-auto max-w-3xl text-center text-ivory">
          <p className="font-display text-lg tracking-[0.22em] text-gold opacity-0">
            A BETTER WHOLESALE PARTNER STARTS HERE
          </p>
          ...
          <p className="mx-auto mt-5 max-w-xl text-base leading-relaxed text-ivory/75 opacity-0 md:text-lg">
            Share your products, volumes, and packaging requirements. We&apos;ll
            respond with clear wholesale pricing and availability.
          </p>
