 ...
 *   1. admin@wholesalenutsupply.com / Wholesale@123  (SUPER_ADMIN)
 *   2. A "WNS Warehouse" branch (BranchType.WAREHOUSE)
 *   3. warehouse@wholesalenutsupply.com / Warehouse@123  (WAREHOUSE_MANAGER, attached to the warehouse)
 *
...
async function seed() {
  ...
  // 1. SUPER_ADMIN
  const superAdminPwd = await bcrypt.hash('Wholesale@123', 10);
  ...
  console.log('\n=== Credentials ===');
  console.log('  Super Admin:  admin@wholesalenutsupply.com / Wholesale@123');
  console.log('  Warehouse:    warehouse@wholesalenutsupply.com / Warehouse@123');
}
