    ...
    <section ref={root} className="relative overflow-hidden py-20 md:py-28">
      <div className="absolute inset-0">
        <Image
          ...
          alt="Bulk nuts ready for wholesale orders"
          fill
          sizes="100vw"
          className="products-cta-bg object-cover scale-105"
        />
      ...
      <div className="container-page relative">
        <div className="products-cta-content mx-auto max-w-3xl text-center text-ivory">
          ...
          <h2 className="mt-4 font-display text-4xl leading-tight md:text-5xl lg:text-6xl opacity-0 text-balance">
            Request wholesale pricing for your next order.
          </h2>
          <p className="mx-auto mt-5 max-w-xl text-base leading-relaxed text-ivory/75 opacity-0 md:text-lg">
            Tell us the products, volumes, and packaging you need. We&apos;ll
