      ...
      <html>
        <head>
          ...
          <style>
            ...
            .total { margin-top: 14px; text-align: right; font-size: 20px; font-weight: 700; color: #1b4d2c; }
          </style>
        </head>
        <body>
          <div class="receipt">
            <div class="brand">
              <img src="${typeof window !== 'undefined' ? window.location.origin : ''}/logo.png" alt="Wholesale Nut Supply" onerror="this.style.display='none'"/>
              <div class="brand-name">WHOLESALE NUT SUPPLY</div>
            </div>
